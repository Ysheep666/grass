...
class GsAppBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  ...
  @override
  _GsAppBarState createState() {
    return _GsAppBarState();
  }
}
...
class _GsAppBarState extends State<GsAppBar> {
...
class _PersistentNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (leading == null && backChevron != null && backLabel != null) {
      leading = GsAppBarBackButton._assemble(
        backChevron,
        backLabel,
      );
    }
...
/// `automaticallyImplyLeading` is true.
///
/// When manually inserted, the [GsAppBarBackButton] should only
...
class GsAppBarBackButton extends StatelessWidget {
  /// Construct a [GsAppBarBackButton] that can be used to pop
  /// the current route.
  ///
  /// The [color] parameter must not be null.
  const GsAppBarBackButton({
    this.color,
    this.previousPageTitle,
    this.onPressed,
  }) : _backChevron = null,
  ...
  const GsAppBarBackButton._assemble(
    this._backChevron,
    this._backLabel,
  ...
  Widget build(BuildContext context) {
    ...
    if (onPressed == null) {
      assert(
        ...
        'GsAppBarBackButton should only be used in routes that can be popped',
      );
    }
